...
@extends('templates/registro_de_material_layout')
@section('content')
<h1 class="h3 fw-bold mb-4">Gerenciamento de Subcategorias</h1>
<div class="d-flex justify-content-between align-items-center mb-3">
    <form class="d-flex" style="max-width: 400px;" method="GET" action="{{ route('subcategorias.subcategorias') }}">
        <input class="form-control me-2" type="search" name="q" value="{{ request('q') }}"
            placeholder="Pesquisar subcategorias..." aria-label="Pesquisar">
                ...
                <tr>
                    ...
                    <td class="d-flex align-items-center gap-2">
                        <form action="{{ route('subcategoria.destroy', $sub->id) }}" method="POST"
                            ...
                            onsubmit="return confirm('Tem certeza que deseja excluir esta Suvategoria?')">
                            @csrf
                            @method('DELETE')
                        ...
                        <a href="{{ route('subcatecategorias.edit', $subcategorias->id) }}" class="text-decoration-none text-dark">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
